           ...
           Rectangle()
            ...
            ZStack{
                ...
                Text(SongArtist).font(.subheadline).foregroundColor(Color("SecondaryTextColor"))
                    ...
                    }.padding([.top, .leading, .trailing], 40.0).overlay(
                        
                        VStack {
                            Rectangle()
                                    .frame(width: 500, height:90, alignment: .top)
...
struct Chords_Previews: PreviewProvider {
    static var previews: some View {
        Chords(SongTitle: "Sample Song", SongArtist: "Sample Artist", SongArtwork: Image("disco"))
    }
}
