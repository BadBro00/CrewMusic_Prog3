            ...
            ZStack{
                ...
                Text(SongArtist).font(.subheadline).foregroundColor(Color("SecondaryTextColor"))
                    ...
                    List(viewModel.songs){
                      song in
                      SongView(song: song)
                    }.padding([.top, .leading, .trailing], 45.0).overlay(
...
struct RelatedSongView_Previews: PreviewProvider {
    static var previews: some View {
        RelatedSongView(SongTitle: "Sample Song", SongArtist: "Sample Artist", SongArtwork: Image("disco"))
    }
}
